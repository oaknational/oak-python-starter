...
- **Deprecated commands tier**: migrate `.agent/commands/` (and the `oak-*` adapters + `_audit_command_parity`) to skills, as the ecosystem repo already has — eventually needed, explicitly not a priority.
